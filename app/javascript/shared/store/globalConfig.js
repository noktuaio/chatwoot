...
const {
  ...
  GIT_SHA: gitSha,
  CAMPAIGN_IMPORT_ENABLED: campaignImportEnabled,
  WHATSAPP_API_CAMPAIGNS_ENABLED: whatsappApiCampaignsEnabled,
  CRM_KANBAN_ENABLED: crmKanbanEnabled,
...
const state = {
  ...
  brandName,
  chatwootInboxToken,
  campaignImportEnabled: parseBoolean(campaignImportEnabled),
  whatsappApiCampaignsEnabled: parseBoolean(whatsappApiCampaignsEnabled),
  crmKanbanEnabled: parseBoolean(crmKanbanEnabled),
