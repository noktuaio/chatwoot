export default {
  ...
  // Campaign Imports
  SET_CAMPAIGN_IMPORT_UI_FLAG: 'SET_CAMPAIGN_IMPORT_UI_FLAG',
  SET_CAMPAIGN_IMPORT_META: 'SET_CAMPAIGN_IMPORT_META',
  SET_CAMPAIGN_IMPORTS: 'SET_CAMPAIGN_IMPORTS',
  ADD_CAMPAIGN_IMPORT: 'ADD_CAMPAIGN_IMPORT',
  EDIT_CAMPAIGN_IMPORT: 'EDIT_CAMPAIGN_IMPORT',
  DELETE_CAMPAIGN_IMPORT: 'DELETE_CAMPAIGN_IMPORT',

  // WhatsApp API Campaigns
  SET_WHATSAPP_API_CAMPAIGN_UI_FLAG: 'SET_WHATSAPP_API_CAMPAIGN_UI_FLAG',
  SET_WHATSAPP_API_CAMPAIGN_META: 'SET_WHATSAPP_API_CAMPAIGN_META',
  SET_WHATSAPP_API_CAMPAIGNS: 'SET_WHATSAPP_API_CAMPAIGNS',
  ADD_WHATSAPP_API_CAMPAIGN: 'ADD_WHATSAPP_API_CAMPAIGN',
  EDIT_WHATSAPP_API_CAMPAIGN: 'EDIT_WHATSAPP_API_CAMPAIGN',
  ...
  DELETE_EMAIL_SENDER_IDENTITY: 'DELETE_EMAIL_SENDER_IDENTITY',
  ...
  // CRM Kanban
  SET_CRM_KANBAN_UI_FLAG: 'SET_CRM_KANBAN_UI_FLAG',
  SET_CRM_KANBAN_PIPELINES: 'SET_CRM_KANBAN_PIPELINES',
  ADD_CRM_KANBAN_PIPELINE: 'ADD_CRM_KANBAN_PIPELINE',
  UPSERT_CRM_KANBAN_PIPELINE: 'UPSERT_CRM_KANBAN_PIPELINE',
  REMOVE_CRM_KANBAN_PIPELINE: 'REMOVE_CRM_KANBAN_PIPELINE',
  SET_CRM_KANBAN_BOARD: 'SET_CRM_KANBAN_BOARD',
  APPEND_CRM_KANBAN_STAGE_CARDS: 'APPEND_CRM_KANBAN_STAGE_CARDS',
  SET_CRM_KANBAN_FILTERS: 'SET_CRM_KANBAN_FILTERS',
  RESTORE_CRM_KANBAN_STAGES: 'RESTORE_CRM_KANBAN_STAGES',
  UPSERT_CRM_KANBAN_STAGE: 'UPSERT_CRM_KANBAN_STAGE',
  REMOVE_CRM_KANBAN_STAGE: 'REMOVE_CRM_KANBAN_STAGE',
  UPSERT_CRM_KANBAN_CARD: 'UPSERT_CRM_KANBAN_CARD',
  REMOVE_CRM_KANBAN_CARD: 'REMOVE_CRM_KANBAN_CARD',
  SET_CRM_CARDS_LIST: 'SET_CRM_CARDS_LIST',
  UPSERT_CRM_CARD_IN_LIST: 'UPSERT_CRM_CARD_IN_LIST',
  REMOVE_CRM_CARD_FROM_LIST: 'REMOVE_CRM_CARD_FROM_LIST',
  SET_CRM_FOLLOW_UPS: 'SET_CRM_FOLLOW_UPS',
  UPSERT_CRM_FOLLOW_UP: 'UPSERT_CRM_FOLLOW_UP',
  REMOVE_CRM_FOLLOW_UP: 'REMOVE_CRM_FOLLOW_UP',
  SET_CRM_CALENDAR_EVENTS: 'SET_CRM_CALENDAR_EVENTS',
  SET_CRM_LIST_PREFS: 'SET_CRM_LIST_PREFS',
  SET_CRM_LIST_SORT: 'SET_CRM_LIST_SORT',
  SET_CRM_LIST_GROUP_BY: 'SET_CRM_LIST_GROUP_BY',
  SET_CRM_LIST_SELECTION: 'SET_CRM_LIST_SELECTION',
  SET_CRM_GROUP_SUMMARY: 'SET_CRM_GROUP_SUMMARY',
  SET_CRM_SAVED_VIEWS: 'SET_CRM_SAVED_VIEWS',
  UPSERT_CRM_SAVED_VIEW: 'UPSERT_CRM_SAVED_VIEW',
  REMOVE_CRM_SAVED_VIEW: 'REMOVE_CRM_SAVED_VIEW',
  SET_CRM_CALENDAR_VIEW: 'SET_CRM_CALENDAR_VIEW',
  SET_CRM_CALENDAR_RANGE: 'SET_CRM_CALENDAR_RANGE',
  SET_CRM_CALENDAR_INCLUDE_COMPLETED: 'SET_CRM_CALENDAR_INCLUDE_COMPLETED',
  SET_CRM_CALENDAR_OVERLAYS: 'SET_CRM_CALENDAR_OVERLAYS',
  SET_CRM_CALENDAR_OWNER_SCOPE: 'SET_CRM_CALENDAR_OWNER_SCOPE',
};
